...
export default function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "SnatchBot",
      description:
        "an AI-powered chatbot platform that automates customer support.It handles queries, books meetings, processes payments, and more, offering easy setup with no-code integration to improve customer service efficiency.",
      image: "pic1.png",
      category: "web",
